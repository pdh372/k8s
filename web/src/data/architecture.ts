...
/**
 * Layout coordinates live in a 960x620 SVG viewBox. The interactive worker
 * node (Worker Node 1) holds the node-level components; a second worker box is
 * drawn decoratively in the diagram component to imply "N identical nodes".
 */
